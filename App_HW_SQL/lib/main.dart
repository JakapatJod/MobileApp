...
class _HomePageState extends State<HomePage> {
  ...
  void _showForm(int? id) async {
    ...
    _selectedDate = existingJournal?['birthdate'];
  ...
  Future<void> _addItem(double weight, double height, double bmi) async {
    await SQLHelper.createItem(
      ...
      _image != null ? _image!.path : null, // Pass image path if available
    );
      ...
      body: isLoading
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) => Card(
                color: Color.fromARGB(133, 62, 198, 239),
                margin: const EdgeInsets.all(15),
                child: ListTile(
                  title: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Name: ${journals[index]['title']}'),
                      Text('Age: ${journals[index]['description']}'),
                      Text('Weight: ${journals[index]['weight']}'),
                      Text('Height: ${journals[index]['height']}'),
                      Text('BMI: ${journals[index]['bmi'].toStringAsFixed(2)}'),
                      Text('Gender: ${journals[index]['gender']}'),
                      Text(
                          'Birthdate: ${journals[index]['birthdate'].toString()}'),
