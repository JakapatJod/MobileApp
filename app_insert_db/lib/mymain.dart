...
class _ShowInfState extends State<ShowInf> {
  ...
  Future<String> listData() async {
    var response = await http.get(Uri.http('10.2.2.2:80', 'emp'),
  ...
  void del_data(int id) async {
    var response = await http.delete(Uri.http('10.2.2.2:80', 'delete/$id'),
  ...
  void edit_data(id) async {
    ...
    var response = await http.put(
      Uri.http('10.2.2.2:80', 'update/$id'),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
      },
      body: body,
