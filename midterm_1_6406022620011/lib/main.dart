...
class PhoneCAL {
  ...
  PhoneCAL(this.name, this.price, this.img);
}
...
class _MyHomePageState extends State<MyHomePage> {
  List<PhoneCAL> menu = [
    PhoneCAL("กุ้งเผา", "200", "assets/images/ipad.jpg"),
    PhoneCAL("กระเพราหมู", "60", "assets/images/pc.jpg"),
    PhoneCAL("ทะเลเผา", "199", "assets/images/tablet.jpg"),
  ...
  void _showDialog(PhoneCAL selectedMenu) {
  ...
  void _addItemToCart(PhoneCAL selectedMenu) {
    setState(() {
...
class _ShoppingCartScreenState extends State<ShoppingCartScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          final PhoneCAL item = widget.shoppingCart.items[index];
  ...
  void _removeItem(PhoneCAL item) {
    setState(() {
