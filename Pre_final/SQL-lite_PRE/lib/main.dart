...
class _HomePageState extends State<HomePage> {
  ...
  void _showForm(int? id) async {
    if (id != null) {
      ...
      _selectedGender = existingJournal['gender']; // Set selected gender
    }
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  _selectedGender = 'Male'; // Reset selected gender to default
  ...
  Future<void> _addItem() async {
    ...
    await SQLHelper.createItem(
        ...
        bmi,
        _selectedGender); // Pass selected gender to createItem
    _refreshJournals();
  }
  ...
  Future<void> _updateItem(int id) async {
    ...
    await SQLHelper.updateItem(
        ...
        double.tryParse(_weightController.text),
        bmi,
        _selectedGender); // Pass selected gender to updateItem
    _refreshJournals();
  }
                ...
                child: ListTile(
                  ...
                  subtitle: Column(
                    ...
                    children: [
                      ...
                      Text(
                          'Gender: ${_journals[index]['gender']}'), // Display gender
